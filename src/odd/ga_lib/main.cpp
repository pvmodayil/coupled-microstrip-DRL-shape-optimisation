...
int main(){
    ...
    Eigen::ArrayXd x_leftD = Eigen::Map<const Eigen::ArrayXd>(dataD["x_left"].data(), dataD["x_left"].size(), 1); // Mx1
    Eigen::ArrayXd g_leftD = Eigen::Map<const Eigen::ArrayXd>(dataD["g_left"].data(), dataD["g_left"].size(), 1); // Mx1
    Eigen::ArrayXd x_rightD = Eigen::Map<const Eigen::ArrayXd>(dataD["x_right"].data(), dataD["x_right"].size(), 1); // Mx1
    Eigen::ArrayXd g_rightD = Eigen::Map<const Eigen::ArrayXd>(dataD["g_right"].data(), dataD["g_right"].size(), 1); // Mx1
